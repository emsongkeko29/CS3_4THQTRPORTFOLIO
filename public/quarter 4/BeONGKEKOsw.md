...
The sidebar was slightly moved to the lower right, causing an overlap with the sidebar and main content.
...
You can't scroll anymore. The footer is still visible but its down there.
...
Absolute makes the element's position based on the parent element. Fixed is based on the viewport, not the parent element.
...
The notice appears on top because the z-index is higher. If you swap the z-index values, the layering will change.
